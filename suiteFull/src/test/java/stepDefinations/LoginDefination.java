...
import com.TestFrame.suiteFull.HomePage;
...
public class LoginDefination extends Base{
	...
	public void initiazile_the_browser_with_chrome() {
		...
		try {
			...
			log.info("Initialazing driver in Login defination");
		} catch (IOException e) {
			log.error("Something went wrong initializing driver in step Defination");
			e.printStackTrace();
		}
